...
export const appRotas: Routes =[
    ...
    {
        path:'abastecimento', loadChildren: ()=> import('./pages/operation/abastecimento/abastecimento.module').then(x =>x.AbastecimentoModule),canLoad:[UserAutenticatedService]
